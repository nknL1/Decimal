...
START_TEST(test1) {
  ...
  ck_assert_int_eq(1, s21_is_greater_or_equal(src, src2));
}
END_TEST
...
START_TEST(test2) {
  ...
  ck_assert_int_eq(0, s21_is_greater_or_equal(src, src2));
}
END_TEST
...
Suite *test_s21_is_greater_or_equal(void) {
  ...
  TCase *tc = tcase_create("tc_s21_is_greater_or_equal");
